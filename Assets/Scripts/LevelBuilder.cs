...
/// <summary>
/// Clase para generar el nivel del juego, incluyendo suelos, paredes, �tems decorativos, monedas y el borde exterior.
/// </summary>
public class LevelBuilder : NetworkBehaviour
{
    ...
    [Tooltip("Array con los prefabs de �tems decorativos")]
    ...
    /// <summary>
    /// Crea una matriz de habitaciones y calcula los puntos de aparici�n.
    /// </summary>
    private void CreateRooms(int roomWidth, int roomLength, int numberOfRooms)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            ...
            {
                float x = j * roomWidth;  // Posici�n X
                float z = i * roomLength; // Posici�n Z
    ...
    /// <summary>
    /// Crea una habitaci�n con suelos y paredes.
    /// </summary>
    ...
    /// <summary>
    /// Instancia un prefab en una posici�n espec�fica con una rotaci�n espec�fica.
    /// </summary>
    ...
    /// <summary>
    /// Coloca �tems decorativos en las baldosas del suelo.
    /// </summary>
    ...
    private void CreateCoin(int x, int z, int width, int length, Vector3 tilePosition)
    {
        ...
        {
            float checkRadius = 0.5f; // Ajusta seg�n el tama�o de los prefabs
            ...
            if (!isPositionOccupied) // Si no hay obst�culos, colocar la moneda
            {
    ...
    /// <summary>
    /// Determina si se debe colocar un �tem decorativo basado en la densidad configurada.
    /// </summary>
    ...
    /// <summary>
    /// Obtiene la lista de puntos de aparici�n de humanos.
    /// </summary>
    /// <returns>Lista de puntos de aparici�n de humanos.</returns>
    ...
    /// <summary>
    /// Obtiene la lista de puntos de aparici�n de zombies.
    /// </summary>
    /// <returns>Lista de puntos de aparici�n de zombies.</returns>
    ...
    /// <summary>
    /// Obtiene el n�mero de monedas generadas.
    /// </summary>
    /// <returns>N�mero de monedas generadas.</returns>
